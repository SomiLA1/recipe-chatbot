...
public class DomainClassifier {
	...
	private void initializeDomainDictionary() {
		...
		domainDictionary = new String[]{"Other", "Recipe"};
		//weather = recipe 
	...
	private Double[] calculateDomainScores(String nowInputText) {
		...
		String[] recipeDictionary = new String[] {"how", "cook", "recipe","food", "make"};
		for(String recipeKeyword: recipeDictionary) {
			if(nowInputText.toLowerCase().indexOf(recipeKeyword)>=0) {
	...
	//	String[] foodDictionary = new String[] {"food", "eat", "hungry", "spicy", "sweet", "sour", "bitter"};
