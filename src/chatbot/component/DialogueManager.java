...
public class DialogueManager {
	...
	private String calculateNextState() {
		...
		switch (latestNonNullIntent) {
			...
			case "Find_recipe_by_food_type":
				if(hasSlotValue("Allergens")) {
					return "ANSWER-FDTYPE";
				}else {
					return "ASK-RECIPE";
				}
			//break;
	
			case "Find_recipe_by_price":
				if(hasSlotValue("Allergens")) {
					return "ANSWER-FDPRICE";
				}else {
					return "ASK-RECIPE";
				}
				//break;
	
			case "Find_recipe_by_ingredient":
				if(hasSlotValue("Allergens")) {
					return "ANSWER-FDINGDENT";
				}else {
					return "ASK-RECIPE";
				}
				//break;
