...
public class FoodIntentClassifier {
	...
	private Double[] calculateIntentScores(String nowInputText) {
		...
		String[] FindFoodDictionary = new String[] {"where", "find", "nearest", "closet","distance"};
		...
		String[] OrderFoodDictionary = new String[] {"price", "order", "deliver"};
		for(String OrderFoodKeyword: OrderFoodDictionary) {
			if(nowInputText.toLowerCase().indexOf(OrderFoodKeyword)>=0) {
