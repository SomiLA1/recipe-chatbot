...
public class ChatbotGUI extends JFrame {
	...
	public ChatbotGUI(Chatbot nowChatbot) {
		...
		nowGUIFrame.getContentPane().setBackground(new Color(160,220,153));
		...
		psuButton.addActionListener(new ButtonListener(inputTextBox, chatHistoryPane, this, psuButton));
		psuButton.setBackground(new Color(114,166,201));
	}
...
class ButtonListener implements ActionListener{
	...
	private JButton nowpsuButton;
	//private JTextField nowInputTextBox;
	private JTextPane nowChatHistoryPane;
	
	public ButtonListener(JTextField inputTextBox, JTextPane chatHistoryPane, ChatbotGUI chatbotUtil, JButton psuButton) {
		this.chatbotUtil = chatbotUtil;
		nowInputTextBox = inputTextBox;
		nowChatHistoryPane = chatHistoryPane;
		nowpsuButton = psuButton;
	...
	public void actionPerformed(ActionEvent e) {
		...
		//time 
				class helper extends TimerTask {
					public void run() {
						nowpsuButton.setBackground(new Color(114,166,201));
					}
					
				}
				
		nowpsuButton.setBackground(new Color(152, 158,162));
		Timer timer = new Timer();
		TimerTask timetask = new helper();
		
		timer.schedule(timetask, 200);
