...
import chatbot.component.RecipeIntentClassifier;
...
public class Chatbot {
	...
	private RecipeIntentClassifier recipeIntentClassifier;
	...
	this.recipeIntentClassifier = new RecipeIntentClassifier();
	...
	public String getResponse(String nowInputText) {
	    ...
	    if(!nowDomain.equals("Other")) {//in-domain message
	      ...
	      //  }else
	        	if(nowDomain.equals("Recipe")) {//Weather domain
	        	nowIntent = recipeIntentClassifier.getLabel(nowInputText);
